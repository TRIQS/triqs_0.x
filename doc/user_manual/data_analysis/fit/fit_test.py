...
from pytriqs.base.gf.local import GfImFreq, Omega, inverse

g = GfImFreq(indices = [0], beta = 300, n_matsubara = 1000, name = "g")
g <<= inverse( Omega + 0.5 )
...
from pytriqs.base.fit import Fit, linear, quadratic
