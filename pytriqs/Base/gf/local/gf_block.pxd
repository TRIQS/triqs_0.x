...
cdef extern from "triqs/gf/gf.hpp"  : 
    ...
    cdef cppclass gf_block_view "triqs::gf::gf_view<triqs::gf::block<DESC> >" [DESC]:
        gf_block_view()
        gf_block_view(gf_mesh[DESC], array_view[dcomplex, THREE,COrder], tail_view, nothing) #except +
        void rebind( gf_block_view&)
        gf_mesh[DESC] mesh() 
