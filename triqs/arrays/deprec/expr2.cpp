...
namespace ExpressionTools { 
 ...
 namespace details { 
  template<typename Obj, typename Expr> 
   struct map_impl : Tag::expression, Tag::expression_terminal {
 ...
 namespace details { 
  ...
  template<typename Expr> 
   struct transpose_impl : Tag::expression, Tag::expression_terminal {
    typedef typename Expr::value_type   value_type;
    typedef typename Expr::domain_type  domain_type;
    Expr const & a;
  ...
  template<class Expr, template <class Expr2> class Transfo>
   struct transfo_impl : Transfo<Expr>,  Tag::expression, Tag::expression_terminal { 
...
int main(int argc, char **argv) {
...

 {
  ...
  triqs::arrays::vector<double> V1(3), V2(3);
