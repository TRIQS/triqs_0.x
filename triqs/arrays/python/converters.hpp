...
namespace triqs { namespace python_tools { 
  ...
  template<typename T, int rank, typename Opt > 
   struct converter<arrays::array_view<T,rank,Opt>  > {
    static bool Py2C_is_possible (bpy::object obj) {
     try  { arrays::array_view<T,rank,Opt>  A(obj.ptr()); }
     catch(runtime_error s) { std::cerr<<s.what()<<std::endl; return false;}
     return true;
    }
    static arrays::array_view<T,rank,Opt> Py2C(bpy::object X) { return  arrays::array_view<T,rank,Opt> (X.ptr());}
    static bpy::object C2Py (arrays::array_view<T,rank,Opt>  const & a) { 
  ...
  template<typename T, typename Opt > 
   struct converter<arrays::matrix_view<T,Opt>  > {
    static bool Py2C_is_possible (bpy::object obj) {
     try  { arrays::matrix_view<T,Opt>  A(obj.ptr()); }
     catch(runtime_error s) { return false;}
     return true;
    }
    static arrays::matrix_view<T,Opt> Py2C(bpy::object X) { return  arrays::matrix_view<T,Opt> (X.ptr());}
    static bpy::object C2Py (arrays::matrix_view<T,Opt> a){return converter<arrays::array_view<T,2,Opt> >::C2Py(a);} 
   };
  ...
  template<typename T, int rank, typename Opt > 
   struct converter<arrays::array<T,rank,Opt>  > {
    typedef void value_not_suitable_for_automatic_conversion_tag; 
    static bool Py2C_is_possible (bpy::object obj) { 
     try  { arrays::array<T,rank,Opt>  A(obj.ptr()); }
     catch(runtime_error s) { std::cerr<<s.what()<<std::endl; return false;}
     return true;
    }
    /*static bool Py2C_is_possible (bpy::object obj) { 
      ...
      return false;} 
      */
    static arrays::array<T,rank,Opt> Py2C(bpy::object X) { return arrays::array<T,rank,Opt> (X.ptr());}
    static bpy::object C2Py (arrays::array<T,rank,Opt>  const & a) { return converter<arrays::array_view<T,rank,Opt> >::C2Py(a);}
   };

  template<typename T, typename Opt > 
   struct converter<arrays::matrix<T,Opt>  > {
    typedef void value_not_suitable_for_automatic_conversion_tag; 
    static bool Py2C_is_possible (bpy::object obj) { 
     try  { arrays::matrix<T,Opt>  A(obj.ptr()); }
     catch(runtime_error s) { std::cerr<<s.what()<<std::endl; return false;}
     return true;
    }
    /*static bool Py2C_is_possible (bpy::object obj) { 
      ...
      return false;} 
      */
    static arrays::matrix<T,Opt> Py2C(bpy::object X) { return arrays::matrix<T,Opt> (X.ptr());}
    static bpy::object C2Py (arrays::matrix<T,Opt> const & a ){return converter<arrays::matrix_view<T,Opt> >::C2Py(a);} 
   };
...
#define ONE(z,N,unused)\
   python_tools::register_converter< arrays::array_view<T,BOOST_PP_INC(N),arrays::Option::C> > ();\
   python_tools::register_converter< arrays::array_view<T,BOOST_PP_INC(N),arrays::Option::Fortran> > ();
   BOOST_PP_REPEAT(ARRAY_NRANK_MAX, ONE, nil);
#undef ONE

#define CONVERT_ALSO_MATRIX_VECTOR 
#ifdef CONVERT_ALSO_MATRIX_VECTOR
   python_tools::register_converter< arrays::matrix_view<T,arrays::Option::C> > ();
   python_tools::register_converter< arrays::matrix_view<T,arrays::Option::Fortran> > ();
   python_tools::register_converter< arrays::vector_view<T,arrays::Option::C> > ();
#endif
  }
